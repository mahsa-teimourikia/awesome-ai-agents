export const questions = [
  {
    ...
    source: { label: "Computer-Using Agents", url: "curriculum/beginner/05-computer-using-agents/README.md" },
  },
  {
    ...
    source: { label: "Computer-Using Agents", url: "curriculum/beginner/05-computer-using-agents/README.md#3-browser-automation-versus-visual-computer-use" },
  },
  {
    ...
    source: { label: "Computer-Using Agents", url: "curriculum/beginner/05-computer-using-agents/README.md#6-ui-changes-and-failure-recovery" },
  },
  {
  ...
  },
  {
    ...
    category: "Interoperability & Skills",
    ...
    source: { label: "MCP: Model Context Protocol", url: "curriculum/advanced/13-mcp-model-context-protocol/README.md" },
  },
  {
    id: "mcp-write-safety",
    category: "Interoperability & Skills",
    ...
    source: { label: "MCP: Model Context Protocol", url: "curriculum/advanced/13-mcp-model-context-protocol/README.md#security-risks-and-mitigations" },
  },
  {
    id: "skills-vs-tools",
    category: "Interoperability & Skills",
    ...
    source: { label: "Agent Skills", url: "curriculum/advanced/14-agent-skills/README.md#tools-versus-skills" },
  },
  {
    ...
    source: { label: "Agent Skills", url: "curriculum/advanced/14-agent-skills/README.md#security-and-production-checklist" },
  },
  {
    ...
    source: { label: "Agent Orchestration", url: "curriculum/enterprise-agent/15-agent-orchestration/README.md" },
  },
  {
    ...
    source: { label: "Agent Communication and Coordination", url: "curriculum/enterprise-agent/16-agent-communication-coordination/README.md#when-does-multi-agent-outperform-one-well-designed-agent" },
  },
  {
    ...
    source: { label: "Agent Communication and Coordination", url: "curriculum/enterprise-agent/16-agent-communication-coordination/README.md#communication-is-a-system-contract" },
  },
  {
