...
- **Enterprise Agent:** complete [Designing Reliable Agentic Systems](curriculum/enterprise-agent/01-designing-reliable-agentic-systems/README.md) to synthesize autonomy, reliability, context, memory, security, latency, and determinism trade-offs into a release-ready architecture.
